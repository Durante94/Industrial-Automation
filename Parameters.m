...
Tout = 333;      %maximum value for T_{out} [K]
mMAX = 5;        %maximum value for the water mass flow rate [kg/s]
delta_t = 180;   %time step [s]
DTemp = 180;     %temperature difference between T_{out}\left(t\right) and T_{in}\left(t\right) [K]
...
hint = 8;        %convective heat transfer coefficient [W/m2K]
